...
export const Banner = () => {
    return (
        <section className="w-full flex pt-5 items-center">
            <div className="w-full flex flex-col gap-9">
                ...
                <p className="text-base max-w-[504px]">
                    Realizamos o sonho de todos de ter uma construção digna e moderna, ou um sistema inteligente que ajude na gestão do dia
                    a dia, transformando esse sonho em um direito para todos
                </p>
                <div>
