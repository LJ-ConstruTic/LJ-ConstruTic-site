...
export const GoalItem = ({
    ...
    if (isHorizontal) {
        return (
            <div className="lg:max-w-[275.99px] w-full h-[234px] dark:border bg-slate-50 dark:bg-slate-900 rounded-[8px] flex flex-col gap-1 pt-1">
                <div className="relative -left-6 flex items-center gap-6">
                    <div className="w-[80px] h-[80px] rounded-full flex items-center justify-center  bg-green-500">
                        <span className="text-white text-2xl lg:text-4xl font-bold">{index.toString()}</span>
                    </div>
                    <h3 className="font-bold text-xl relative -top-4 ">Meta {index}</h3>
                </div>
    ...
    return (
        <div className="lg:max-w-[414px] dark:border w-full h-[148px] bg-slate-50 dark:bg-slate-900 rounded-[8px] flex gap-1 pt-4">
            <div className="relative -left-6">
                <div className="w-[80px] h-[80px] rounded-full flex items-center justify-center bg-green-500">
                    <span className="text-white text-xl  lg:text-4xl font-bold">{index.toString()}</span>
                </div>
            </div>
            <div className="w-full">
                <h3 className="font-bold text-xl ">Meta {index}</h3>
